...
class SearchCustomer():
    ...
    def searchCustomerByEmail(self,email):
        ...
        for r in range(1,self.getNoOfRows()+1):
            ...
            email=table.find_element(By.XPATH,"//table[@id= 'customer-grid']//tbody/tr["+str(r)+"]/td[2]").text
            if email == email:
                flag = True
                break
            return flag
    ...
    def searchCustomerByName(self,Name):
        ...
        for r in range(1,self.getNoOfRows()+1):
            table=self.driver.find_element(By.XPATH,self.table_xpath)
            name=table.find_element(By.XPATH,"//table[@id= 'customer-grid']//tbody/tr["+str(r)+"]/td[3]").text
            if name == name:
                flag = True
                break
            return flag
